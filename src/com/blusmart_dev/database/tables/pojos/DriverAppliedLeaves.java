...
public class DriverAppliedLeaves implements Serializable {

    private static final long serialVersionUID = 1829492324;
    ...
    public DriverAppliedLeaves(DriverAppliedLeaves value) {
        this.id = value.id;
    ...
    public DriverAppliedLeaves setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public DriverAppliedLeaves setLeavesRecordId(UInteger leavesRecordId) {
        this.leavesRecordId = leavesRecordId;
        return this;
    }
    ...
    public DriverAppliedLeaves setDriverId(UInteger driverId) {
        this.driverId = driverId;
        return this;
    }
    ...
    public DriverAppliedLeaves setFromTimestamp(Long fromTimestamp) {
        this.fromTimestamp = fromTimestamp;
        return this;
    }
    ...
    public DriverAppliedLeaves setToTimestamp(Long toTimestamp) {
        this.toTimestamp = toTimestamp;
        return this;
    }
    ...
    public DriverAppliedLeaves setTotalHours(BigDecimal totalHours) {
        this.totalHours = totalHours;
        return this;
    }
    ...
    public DriverAppliedLeaves setState(String state) {
        this.state = state;
        return this;
    }
    ...
    public DriverAppliedLeaves setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public DriverAppliedLeaves setCreatedTimestamp(Long createdTimestamp) {
        this.createdTimestamp = createdTimestamp;
        return this;
    }
    ...
    public DriverAppliedLeaves setLastUpdatedTimestamp(Long lastUpdatedTimestamp) {
        this.lastUpdatedTimestamp = lastUpdatedTimestamp;
        return this;
    }
    ...
    public DriverAppliedLeaves setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public DriverAppliedLeaves setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public DriverAppliedLeaves setRejectionReason(String rejectionReason) {
        this.rejectionReason = rejectionReason;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final DriverAppliedLeaves other = (DriverAppliedLeaves) obj;
        if (id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("DriverAppliedLeaves (");
