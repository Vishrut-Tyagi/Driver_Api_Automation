...
public class DriverCreditsDebitsAudit implements Serializable {

    private static final long serialVersionUID = -2143850320;
    ...
    public DriverCreditsDebitsAudit(DriverCreditsDebitsAudit value) {
    ...
    public DriverCreditsDebitsAudit setAuditId(UInteger auditId) {
        this.auditId = auditId;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setLeaseDriverFinalPayoutId(UInteger leaseDriverFinalPayoutId) {
        this.leaseDriverFinalPayoutId = leaseDriverFinalPayoutId;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setOccurrenceTimestamp(Long occurrenceTimestamp) {
        this.occurrenceTimestamp = occurrenceTimestamp;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setDriverId(UInteger driverId) {
        this.driverId = driverId;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setDriverName(String driverName) {
        this.driverName = driverName;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setAmount(BigDecimal amount) {
        this.amount = amount;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setVehicleNumber(String vehicleNumber) {
        this.vehicleNumber = vehicleNumber;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setOtherFlags(String otherFlags) {
        this.otherFlags = otherFlags;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setCreatedTimestamp(Long createdTimestamp) {
        this.createdTimestamp = createdTimestamp;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setLastUpdatedTimestamp(Long lastUpdatedTimestamp) {
        this.lastUpdatedTimestamp = lastUpdatedTimestamp;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public DriverCreditsDebitsAudit setDisbursalTimestamp(Long disbursalTimestamp) {
        this.disbursalTimestamp = disbursalTimestamp;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final DriverCreditsDebitsAudit other = (DriverCreditsDebitsAudit) obj;
        if (auditId == null) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("DriverCreditsDebitsAudit (");
