...
public class DriverLeaveBalanceAud implements Serializable {

    private static final long serialVersionUID = 922644200;
    ...
    public DriverLeaveBalanceAud(DriverLeaveBalanceAud value) {
    ...
    public DriverLeaveBalanceAud setAudId(UInteger audId) {
        this.audId = audId;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setDriverId(UInteger driverId) {
        this.driverId = driverId;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setHourCount(BigDecimal hourCount) {
        this.hourCount = hourCount;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setCreatedTimestamp(Long createdTimestamp) {
        this.createdTimestamp = createdTimestamp;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setLastUpdatedTimestamp(Long lastUpdatedTimestamp) {
        this.lastUpdatedTimestamp = lastUpdatedTimestamp;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setMonth(UInteger month) {
        this.month = month;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setYear(UInteger year) {
        this.year = year;
        return this;
    }
    ...
    public DriverLeaveBalanceAud setAddedHours(BigDecimal addedHours) {
        this.addedHours = addedHours;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final DriverLeaveBalanceAud other = (DriverLeaveBalanceAud) obj;
        if (audId == null) {
            if (other.audId != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("DriverLeaveBalanceAud (");
