...
public class DriverStatesAud implements Serializable {

    private static final long serialVersionUID = -2124442362;
    ...
    public DriverStatesAud(DriverStatesAud value) {
    ...
    public DriverStatesAud setAudId(UInteger audId) {
        this.audId = audId;
        return this;
    }
    ...
    public DriverStatesAud setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public DriverStatesAud setDriverId(UInteger driverId) {
        this.driverId = driverId;
        return this;
    }
    ...
    public DriverStatesAud setDriverState(String driverState) {
        this.driverState = driverState;
        return this;
    }
    ...
    public DriverStatesAud setVehicleNumber(String vehicleNumber) {
        this.vehicleNumber = vehicleNumber;
        return this;
    }
    ...
    public DriverStatesAud setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public DriverStatesAud setCreatedTimestamp(Long createdTimestamp) {
        this.createdTimestamp = createdTimestamp;
        return this;
    }
    ...
    public DriverStatesAud setLastUpdatedTimestamp(Long lastUpdatedTimestamp) {
        this.lastUpdatedTimestamp = lastUpdatedTimestamp;
        return this;
    }
    ...
    public DriverStatesAud setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public DriverStatesAud setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public DriverStatesAud setRideId(UInteger rideId) {
        this.rideId = rideId;
        return this;
    }
    ...
    public DriverStatesAud setLatitude(BigDecimal latitude) {
        this.latitude = latitude;
        return this;
    }
    ...
    public DriverStatesAud setLongitude(BigDecimal longitude) {
        this.longitude = longitude;
        return this;
    }
    ...
    public DriverStatesAud setNextEligibleTimestamp(Long nextEligibleTimestamp) {
        this.nextEligibleTimestamp = nextEligibleTimestamp;
        return this;
    }
    ...
    public DriverStatesAud setIsPaused(Byte isPaused) {
        this.isPaused = isPaused;
        return this;
    }
    ...
    public DriverStatesAud setCurrentDestination(String currentDestination) {
        this.currentDestination = currentDestination;
        return this;
    }
    ...
    public DriverStatesAud setDestinationStatus(String destinationStatus) {
        this.destinationStatus = destinationStatus;
        return this;
    }
    ...
    public DriverStatesAud setPausedBy(Integer pausedBy) {
        this.pausedBy = pausedBy;
        return this;
    }
    ...
    public DriverStatesAud setIsSocRequired(Byte isSocRequired) {
        this.isSocRequired = isSocRequired;
        return this;
    }
    ...
    public DriverStatesAud setPauseReason(String pauseReason) {
        this.pauseReason = pauseReason;
        return this;
    }
    ...
    public DriverStatesAud setOtherFlags(String otherFlags) {
        this.otherFlags = otherFlags;
        return this;
    }
    ...
    public DriverStatesAud setShiftStartTimestamp(Long shiftStartTimestamp) {
        this.shiftStartTimestamp = shiftStartTimestamp;
        return this;
    }
    ...
    public DriverStatesAud setShiftEndTimestamp(Long shiftEndTimestamp) {
        this.shiftEndTimestamp = shiftEndTimestamp;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final DriverStatesAud other = (DriverStatesAud) obj;
        if (audId == null) {
            if (other.audId != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("DriverStatesAud (");
