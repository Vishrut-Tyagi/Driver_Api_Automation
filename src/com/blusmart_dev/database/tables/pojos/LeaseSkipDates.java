...
public class LeaseSkipDates implements Serializable {

    private static final long serialVersionUID = 1745163020;
    ...
    public LeaseSkipDates(LeaseSkipDates value) {
        this.id = value.id;
    ...
    public LeaseSkipDates setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public LeaseSkipDates setDate(Long date) {
        this.date = date;
        return this;
    }
    ...
    public LeaseSkipDates setAvailableQuota(Integer availableQuota) {
        this.availableQuota = availableQuota;
        return this;
    }
    ...
    public LeaseSkipDates setMaxQuota(UInteger maxQuota) {
        this.maxQuota = maxQuota;
        return this;
    }
    ...
    public LeaseSkipDates setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public LeaseSkipDates setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public LeaseSkipDates setCreatedAt(Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public LeaseSkipDates setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public LeaseSkipDates setLastUpdatedAt(Long lastUpdatedAt) {
        this.lastUpdatedAt = lastUpdatedAt;
        return this;
    }
    ...
    public LeaseSkipDates setHubId(UInteger hubId) {
        this.hubId = hubId;
        return this;
    }
    ...
    public LeaseSkipDates setDutyType(String dutyType) {
        this.dutyType = dutyType;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final LeaseSkipDates other = (LeaseSkipDates) obj;
        if (id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("LeaseSkipDates (");
