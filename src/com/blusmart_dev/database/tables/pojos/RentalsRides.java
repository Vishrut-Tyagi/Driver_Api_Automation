...
public class RentalsRides implements Serializable {

    private static final long serialVersionUID = -215625084;
    ...
    private Long       stopMarkedTimeStamp;
    private Byte       isWaitingChargesPriceApplicable;

    public RentalsRides() {}

    public RentalsRides(RentalsRides value) {
        this.id = value.id;
        ...
        this.waitingCharges = value.waitingCharges;
        this.stopMarkedTimeStamp = value.stopMarkedTimeStamp;
        this.isWaitingChargesPriceApplicable = value.isWaitingChargesPriceApplicable;
    }
    ...
    public RentalsRides(
        ...
        Long       stopMarkedTimeStamp,
        Byte       isWaitingChargesPriceApplicable
    ) {
        this.id = id;
        ...
        this.stopMarkedTimeStamp = stopMarkedTimeStamp;
        this.isWaitingChargesPriceApplicable = isWaitingChargesPriceApplicable;
    }
    ...
    public RentalsRides setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public RentalsRides setRiderId(Integer riderId) {
        this.riderId = riderId;
        return this;
    }
    ...
    public RentalsRides setDriverId(Integer driverId) {
        this.driverId = driverId;
        return this;
    }
    ...
    public RentalsRides setStopLatitude(BigDecimal stopLatitude) {
        this.stopLatitude = stopLatitude;
        return this;
    }
    ...
    public RentalsRides setStopLongitude(BigDecimal stopLongitude) {
        this.stopLongitude = stopLongitude;
        return this;
    }
    ...
    public RentalsRides setStopLocation(String stopLocation) {
        this.stopLocation = stopLocation;
        return this;
    }
    ...
    public RentalsRides setDistanceTaken(Integer distanceTaken) {
        this.distanceTaken = distanceTaken;
        return this;
    }
    ...
    public RentalsRides setTimeTaken(Integer timeTaken) {
        this.timeTaken = timeTaken;
        return this;
    }
    ...
    public RentalsRides setStopType(String stopType) {
        this.stopType = stopType;
        return this;
    }
    ...
    public RentalsRides setStopId(Integer stopId) {
        this.stopId = stopId;
        return this;
    }
    ...
    public RentalsRides setMax(Integer max) {
        this.max = max;
        return this;
    }
    ...
    public RentalsRides setCreatedAt(Long createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public RentalsRides setLastUpadtedAt(Long lastUpadtedAt) {
        this.lastUpadtedAt = lastUpadtedAt;
        return this;
    }
    ...
    public RentalsRides setStartTime(Long startTime) {
        this.startTime = startTime;
        return this;
    }
    ...
    public RentalsRides setEndTime(Long endTime) {
        this.endTime = endTime;
        return this;
    }
    ...
    public RentalsRides setCreatedBy(Integer createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public RentalsRides setUpdatedBy(Integer updatedBy) {
        this.updatedBy = updatedBy;
        return this;
    }
    ...
    public RentalsRides setNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public RentalsRides setRideRequestId(Integer rideRequestId) {
        this.rideRequestId = rideRequestId;
        return this;
    }
    ...
    public RentalsRides setStartLocation(String startLocation) {
        this.startLocation = startLocation;
        return this;
    }
    ...
    public RentalsRides setStartLatitude(BigDecimal startLatitude) {
        this.startLatitude = startLatitude;
        return this;
    }
    ...
    public RentalsRides setStartLongitude(BigDecimal startLongitude) {
        this.startLongitude = startLongitude;
        return this;
    }
    ...
    public RentalsRides setLeftTime(Long leftTime) {
        this.leftTime = leftTime;
        return this;
    }
    ...
    public RentalsRides setReachedTime(Long reachedTime) {
        this.reachedTime = reachedTime;
        return this;
    }
    ...
    public RentalsRides setVehicleNumber(String vehicleNumber) {
        this.vehicleNumber = vehicleNumber;
        return this;
    }
    ...
    public RentalsRides setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public RentalsRides setEstimatedDistance(BigDecimal estimatedDistance) {
        this.estimatedDistance = estimatedDistance;
        return this;
    }
    ...
    public RentalsRides setEstimatedTimeStamp(Long estimatedTimeStamp) {
        this.estimatedTimeStamp = estimatedTimeStamp;
        return this;
    }
    ...
    public RentalsRides setActualTimeStamp(Long actualTimeStamp) {
        this.actualTimeStamp = actualTimeStamp;
        return this;
    }
    ...
    public RentalsRides setActualDistance(BigDecimal actualDistance) {
        this.actualDistance = actualDistance;
        return this;
    }
    ...
    public RentalsRides setStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public RentalsRides setIsVisible(Byte isVisible) {
        this.isVisible = isVisible;
        return this;
    }
    ...
    public RentalsRides setStopServiceRegionId(Integer stopServiceRegionId) {
        this.stopServiceRegionId = stopServiceRegionId;
        return this;
    }
    ...
    public RentalsRides setActionBy(String actionBy) {
        this.actionBy = actionBy;
        return this;
    }
    ...
    public RentalsRides setWaitingCharges(BigDecimal waitingCharges) {
        this.waitingCharges = waitingCharges;
        return this;
    }

    public Long getStopMarkedTimeStamp() {
        return this.stopMarkedTimeStamp;
    }

    public RentalsRides setStopMarkedTimeStamp(Long stopMarkedTimeStamp) {
        this.stopMarkedTimeStamp = stopMarkedTimeStamp;
        return this;
    }

    public Byte getIsWaitingChargesPriceApplicable() {
        return this.isWaitingChargesPriceApplicable;
    }

    public RentalsRides setIsWaitingChargesPriceApplicable(Byte isWaitingChargesPriceApplicable) {
        this.isWaitingChargesPriceApplicable = isWaitingChargesPriceApplicable;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final RentalsRides other = (RentalsRides) obj;
        if (id == null) {
            if (other.id != null)
                return false;
        }
        ...
        if (waitingCharges == null) {
            if (other.waitingCharges != null)
                return false;
        }
        else if (!waitingCharges.equals(other.waitingCharges))
            return false;
        if (stopMarkedTimeStamp == null) {
            if (other.stopMarkedTimeStamp != null)
                return false;
        }
        else if (!stopMarkedTimeStamp.equals(other.stopMarkedTimeStamp))
            return false;
        if (isWaitingChargesPriceApplicable == null) {
            if (other.isWaitingChargesPriceApplicable != null)
                return false;
        }
        else if (!isWaitingChargesPriceApplicable.equals(other.isWaitingChargesPriceApplicable))
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.waitingCharges == null) ? 0 : this.waitingCharges.hashCode());
        result = prime * result + ((this.stopMarkedTimeStamp == null) ? 0 : this.stopMarkedTimeStamp.hashCode());
        result = prime * result + ((this.isWaitingChargesPriceApplicable == null) ? 0 : this.isWaitingChargesPriceApplicable.hashCode());
        return result;
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder("RentalsRides (");
        ...
        sb.append(", ").append(waitingCharges);
        sb.append(", ").append(stopMarkedTimeStamp);
        sb.append(", ").append(isWaitingChargesPriceApplicable);
