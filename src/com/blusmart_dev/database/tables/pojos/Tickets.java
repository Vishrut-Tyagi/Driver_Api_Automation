...
public class Tickets implements Serializable {
    ...
    private static final long serialVersionUID = 159531653;
    ...
    public Tickets setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public Tickets setRideRequestId(UInteger rideRequestId) {
        this.rideRequestId = rideRequestId;
        return this;
    }
    ...
    public Tickets setRideId(UInteger rideId) {
        this.rideId = rideId;
        return this;
    }
    ...
    public Tickets setRiderId(UInteger riderId) {
        this.riderId = riderId;
        return this;
    }
    ...
    public Tickets setTicketType(String ticketType) {
        this.ticketType = ticketType;
        return this;
    }
    ...
    public Tickets setTicketStage(String ticketStage) {
        this.ticketStage = ticketStage;
        return this;
    }
    ...
    public Tickets setIncidentId(String incidentId) {
        this.incidentId = incidentId;
        return this;
    }
    ...
    public Tickets setTicketHistoryDetails(String ticketHistoryDetails) {
        this.ticketHistoryDetails = ticketHistoryDetails;
        return this;
    }
    ...
    public Tickets setClosedTimestamp(Long closedTimestamp) {
        this.closedTimestamp = closedTimestamp;
        return this;
    }
    ...
    public Tickets setClosureRemark(String closureRemark) {
        this.closureRemark = closureRemark;
        return this;
    }
    ...
    public Tickets setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public Tickets setCreatedTimestamp(Long createdTimestamp) {
        this.createdTimestamp = createdTimestamp;
        return this;
    }
    ...
    public Tickets setLastUpdatedTimestamp(Long lastUpdatedTimestamp) {
        this.lastUpdatedTimestamp = lastUpdatedTimestamp;
        return this;
    }
    ...
    public Tickets setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public Tickets setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public Tickets setFeedback(String feedback) {
        this.feedback = feedback;
        return this;
    }
