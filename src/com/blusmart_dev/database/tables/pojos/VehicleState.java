...
public class VehicleState implements Serializable {
    ...
    private static final long serialVersionUID = 1723956988;
    ...
    private UInteger currentHub;
    private String   otherFlags;

    public VehicleState() {}

    public VehicleState(VehicleState value) {
        ...
        this.currentHub = value.currentHub;
    ...
    public VehicleState setVehicleNumber(String vehicleNumber) {
        this.vehicleNumber = vehicleNumber;
        return this;
    }
    ...
    public VehicleState setVehicleState(String vehicleState) {
        this.vehicleState = vehicleState;
        return this;
    }
    ...
    public VehicleState setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public VehicleState setCreatedTimestamp(Long createdTimestamp) {
        this.createdTimestamp = createdTimestamp;
        return this;
    }
    ...
    public VehicleState setLastUpdatedTimestamp(Long lastUpdatedTimestamp) {
        this.lastUpdatedTimestamp = lastUpdatedTimestamp;
        return this;
    }
    ...
    public VehicleState setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public VehicleState setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public VehicleState setCurrentHub(UInteger currentHub) {
        this.currentHub = currentHub;
        return this;
    }
    ...
    public VehicleState setOtherFlags(String otherFlags) {
        this.otherFlags = otherFlags;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (lastUpdatedBy == null) {
            ...
            return false;
        if (currentHub == null) {
            if (other.currentHub != null)
                return false;
        }
        else if (!currentHub.equals(other.currentHub))
            return false;
        if (otherFlags == null) {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.currentHub == null) ? 0 : this.currentHub.hashCode());
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("VehicleState (");
