...
public class WalletBalance implements Serializable {
    ...
    private static final long serialVersionUID = 1545490684;
    ...
    public WalletBalance(WalletBalance value) {
        this.id = value.id;
    ...
    public WalletBalance setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public WalletBalance setRiderId(UInteger riderId) {
        this.riderId = riderId;
        return this;
    }
    ...
    public WalletBalance setCurrentBalance(BigDecimal currentBalance) {
        this.currentBalance = currentBalance;
        return this;
    }
    ...
    public WalletBalance setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public WalletBalance setCreatedTimestamp(Long createdTimestamp) {
        this.createdTimestamp = createdTimestamp;
        return this;
    }
    ...
    public WalletBalance setLastUpdatedTimestamp(Long lastUpdatedTimestamp) {
        this.lastUpdatedTimestamp = lastUpdatedTimestamp;
        return this;
    }
    ...
    public WalletBalance setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public WalletBalance setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public WalletBalance setPromotionalCreditsBalance(BigDecimal promotionalCreditsBalance) {
        this.promotionalCreditsBalance = promotionalCreditsBalance;
        return this;
    }
    ...
    public WalletBalance setPromotionalCreditsUsed(BigDecimal promotionalCreditsUsed) {
        this.promotionalCreditsUsed = promotionalCreditsUsed;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final WalletBalance other = (WalletBalance) obj;
        if (id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("WalletBalance (");
