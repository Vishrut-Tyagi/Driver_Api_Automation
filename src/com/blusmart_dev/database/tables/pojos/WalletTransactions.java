...
public class WalletTransactions implements Serializable {
    ...
    private static final long serialVersionUID = -171496772;
    ...
    public WalletTransactions(WalletTransactions value) {
        this.id = value.id;
    ...
    public WalletTransactions setId(UInteger id) {
        this.id = id;
        return this;
    }
    ...
    public WalletTransactions setRideRequestId(UInteger rideRequestId) {
        this.rideRequestId = rideRequestId;
        return this;
    }
    ...
    public WalletTransactions setRiderId(UInteger riderId) {
        this.riderId = riderId;
        return this;
    }
    ...
    public WalletTransactions setAmount(BigDecimal amount) {
        this.amount = amount;
        return this;
    }
    ...
    public WalletTransactions setType(String type) {
        this.type = type;
        return this;
    }
    ...
    public WalletTransactions setFrom(String from) {
        this.from = from;
        return this;
    }
    ...
    public WalletTransactions setTransactionTime(Long transactionTime) {
        this.transactionTime = transactionTime;
        return this;
    }
    ...
    public WalletTransactions setPaymentMode(String paymentMode) {
        this.paymentMode = paymentMode;
        return this;
    }
    ...
    public WalletTransactions setPaymentStatus(String paymentStatus) {
        this.paymentStatus = paymentStatus;
        return this;
    }
    ...
    public WalletTransactions setOrderId(UInteger orderId) {
        this.orderId = orderId;
        return this;
    }
    ...
    public WalletTransactions setClosingBalance(BigDecimal closingBalance) {
        this.closingBalance = closingBalance;
        return this;
    }
    ...
    public WalletTransactions setMessage(String message) {
        this.message = message;
        return this;
    }
    ...
    public WalletTransactions setSubtitle(String subtitle) {
        this.subtitle = subtitle;
        return this;
    }
    ...
    public WalletTransactions setIsActive(Byte isActive) {
        this.isActive = isActive;
        return this;
    }
    ...
    public WalletTransactions setCreatedTimestamp(Long createdTimestamp) {
        this.createdTimestamp = createdTimestamp;
        return this;
    }
    ...
    public WalletTransactions setLastUpdatedTimestamp(Long lastUpdatedTimestamp) {
        this.lastUpdatedTimestamp = lastUpdatedTimestamp;
        return this;
    }
    ...
    public WalletTransactions setCreatedBy(UInteger createdBy) {
        this.createdBy = createdBy;
        return this;
    }
    ...
    public WalletTransactions setLastUpdatedBy(UInteger lastUpdatedBy) {
        this.lastUpdatedBy = lastUpdatedBy;
        return this;
    }
    ...
    public WalletTransactions setRemark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final WalletTransactions other = (WalletTransactions) obj;
        if (id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("WalletTransactions (");
